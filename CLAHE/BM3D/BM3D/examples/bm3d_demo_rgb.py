...
"""
import sys
sys.path.append('/mnt/8T/wangjuan/project/BM3D/')
...
def main():
    ...
    imagename = 'examples/image_Lena512rgb.png'
    ...
    BM3DProfile.filter_strength = filter_strength
    ...
    y_est.save('examples/denoise_lena_{}.jpg'.format(filter_strength))
