...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', required=True, default='./datasets/maps', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--netG', type=str, default='resnet_9blocks', help='specify generator architecture [dehazeformer_ss | resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
